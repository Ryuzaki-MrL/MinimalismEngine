...
void RZFT_DrawText(const RZFT_Font* font, float x, float y, float scaleX, float scaleY, u32 color, int wrapX, int align, const char* text) {
...
void RZFT_DrawTextFormat(const RZFT_Font* font, float x, float y, float scaleX, float scaleY, u32 color, int wrapX, int align, const char* text, ...) {
	static char buffer[256] = "";
	va_list args;
	va_start(args, text);
